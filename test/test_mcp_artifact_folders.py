...
class TestFolderList:
    def test_list_formats_id_path_count(self) -> None:
        with patch("kiro_crew.mcp_core.handlers.artifacts._get", return_value={"folders": _FOLDERS}):
    ...
    def test_list_empty(self) -> None:
        with patch("kiro_crew.mcp_core.handlers.artifacts._get", return_value={"folders": []}):
            out = _call_tool_inner("artifact_folder_list", {})
...
class TestFolderRename:
    def test_rename_resolves_path_then_patches(self) -> None:
        with patch("kiro_crew.mcp_core.handlers.artifacts._get", return_value={"folders": _FOLDERS}), patch(
            "kiro_crew.mcp_core.handlers.artifacts._patch",
