...
BENIGN_SPAWNS: frozenset[str] = frozenset(
    {
        ...
        "agent/workers.py::is_aim_package_installed",
        ...
        "dashboard/handlers/files/browse.py::_run",
        "dashboard/handlers/files/outbox.py::api_reveal_path",
        "dashboard/handlers/files/upload.py::api_screenshot",
        "dashboard/handlers/files/upload.py::api_upload",
        ...
        "mcp_core/identity.py::_get_ppid",
        ...
        "sandbox/backends.py::_probe_sandbox_exec",
        "sandbox/launcher.py::_ssh_supports_accept_new",
