...
class TestWindowsPathShapes:
    ...
    def test_foreign_drive_and_unc_are_not_probed(self) -> None:
        # A token on another drive/share can never match the home-anchored
        # fence; treating it as path-like would only cost a realpath probe of
        # a possibly-dead network target.
        from unittest.mock import patch
