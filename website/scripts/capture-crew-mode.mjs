 ...
 *  2. crew-session.png    — a crew-mode session whose transcript is the REAL
 *                           output of the orchestrator pipeline (captured from
 *                           a driven run), not hand-written: interleaved
