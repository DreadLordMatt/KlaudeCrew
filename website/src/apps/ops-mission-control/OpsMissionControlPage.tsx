        ...
        <>
          ...
          {query.data?.truncated ? (
            <p className="text-xs text-warn mt-1">
              {i18nT('apps.opsMissionControl.opsMissionControlPage.showing_the')} {closed.length} {i18nT('apps.opsMissionControl.opsMissionControlPage.closed_incident_s_in_the_most_recent')}{' '}
                          ...
                          return (
                            <div className="rounded border border-subtle px-2 py-1.5 text-xs">
                              <div className="flex items-center gap-1.5 flex-wrap">
                                ...
                                <span className="text-muted">
                                  {inc.last_action || 'action'} {i18nT('apps.opsMissionControl.opsMissionControlPage.sent')}
