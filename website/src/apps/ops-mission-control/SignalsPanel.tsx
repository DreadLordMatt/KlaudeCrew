      ...
      <Card>
                ...
                {pushSources.length > 0 ? (
                  <>
                    {i18nT('apps.opsMissionControl.signalsPanel.push_source_absence_note', {
                      ...
                      verb: pushSources.length === 1 ? 'it delivers' : 'they deliver',
                    })}
                  </>
                ) : (
        ...
        {webhookQueued > 0 ? (
          <p className="text-[12px] text-muted mt-2 flex items-start gap-1.5">
            ...
            <span>
              {webhookQueued} {i18nT('apps.opsMissionControl.signalsPanel.inbound_webhook_signal_s_delivered_and_waiting_f')}
