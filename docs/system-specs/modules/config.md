...
class AgentConfig:
    ...
    provider: str = "acp"          # fixed to "acp" — every backend speaks ACP
    acp_backend: str = "claude"    # fork: which agent drives ACP sessions — "claude" (claude-agent-acp / Claude Code, default) or "kiro" (kiro-cli)
