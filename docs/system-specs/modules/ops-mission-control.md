...
This deliberately diverges from common incident-response practice, which
...
- The app's development journals (research sweeps, feature ledger, parity report) are
  ...
  altogether: they described the internal workflow this app was modeled on, which is not
  something a public repository should carry. **This system spec is the single source of truth
