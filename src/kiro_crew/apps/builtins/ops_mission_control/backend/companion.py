...
``registry.py`` documents itself as "the seam an Amazon-internal companion package
...
See ``docs/system-specs/modules/ops-mission-control.md`` § Amazon-internal companion.
"""
...
def _admitted(ep: importlib.metadata.EntryPoint) -> tuple[bool, str]:
    ...
    """
    try:
        from kiro_crew.platform.admission import (  # noqa: PLC0415
            evaluate_admission,
