...
Observed live against the beta account: the investigating agent's FIRST action was
...
class TestDeriveStatus(_HomeIsolated):
    ...
    def test_recording_a_diagnosis_clears_awaiting_diagnosis(self):
        ...
        Verified against the real beta-account incidents — an agent that produced a
