...
class TestConcurrentWritesCannotRestoreAStaleCeiling(unittest.TestCase):
    ...
    def test_the_two_halves_of_the_ceiling_commit_together(self):
        ...
        snapshot a reader takes must be one of those two pairs — never a cross. That holds
        deterministically under `set_ceiling` and fails against two separate writes.
        """
        import json
        import threading
